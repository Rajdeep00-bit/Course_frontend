...
function CourseInstanceList({ instances, deleteInstance, year, semester, courses }) {
              ...
              return (
                <tr key={instance.id}>
                  ...
                  <td>
                    ...
                    <button onClick={() => deleteInstance(instance.id, instance.year, instance.semester)}>Delete</button>
                  </td>
                </tr>
              );
            })}
