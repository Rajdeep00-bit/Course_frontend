  ...
  const handleSubmit = (event) => {
    ...
    fetch('http://127.0.0.1:8000/api/instances/', {
      ...
      .then((newInstance) => {
        ...
        // Call the callback to notify the parent component to refetch instances or append the new one
        onInstanceCreated(newInstance); // Notify parent and pass new instance
      })
