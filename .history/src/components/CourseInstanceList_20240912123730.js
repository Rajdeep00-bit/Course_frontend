...
function CourseInstanceList({ instances, deleteInstance, courses }) {
  ...
  const fetchInstanceDetails = (id, year, semester) => {
    ...
    fetch(apiUrl)
      ...
      .then((data) => {
        ...
        setSelectedInstance(data); // Store the fetched instance details
      })
      .catch((error) => {
            ...
            {instances.map((instance) => {
              ...
              return (
                <tr key={instance.id}>
                  ...
                  <td>{code}</td>
                  <td>
                    <button onClick={() => fetchInstanceDetails(instance.id, instance.year, instance.semester)}>
                      View Details
                    </button>
