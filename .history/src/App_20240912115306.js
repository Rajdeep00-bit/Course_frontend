...
function App() {
  ...
  const [selectedInstance, setSelectedInstance] = useState(null); // State for selected course instance details
  ...
  // View details of a course instance
  const viewInstanceDetails = (id) => {
    const instance = instances.find((inst) => inst.id === id);
    setSelectedInstance(instance); // Set the selected instance for viewing
  };
      ...
      <div className="container">
        ...
        <section className="section">
          ...
          <CourseInstanceList
            ...
            viewInstanceDetails={viewInstanceDetails} // Pass the viewInstanceDetails function
          />
        </section>
