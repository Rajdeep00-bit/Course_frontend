...
function App() {
  ...
  const [filterYear, setFilterYear] = useState(''); // Filter for year
  const [filterSemester, setFilterSemester] = useState(''); // Filter for semester
  ...
  return (
    <div className="App">
      ...
      <div className="container">
        ...
        {/* Filter Section for Year and Semester */}
        <section className="section">
          <h2>Filter Course Instances</h2>
          <label>
            Year:
            <input
              type="text"
        ...
        <section className="section">
          ...
          <CourseInstanceList
            ...
            year={filterYear} // Pass the filterYear to CourseInstanceList
            semester={filterSemester} // Pass the filterSemester to CourseInstanceList
