...
import CourseInstanceForm from './CourseInstanceForm';  // Adjust import path accordingly
import CourseInstanceList from './CourseInstanceList';  // Adjust import path accordingly
