...
function App() {
  ...
  // Handle new instance creation and update the list automatically
  const handleInstanceCreated = (newInstance) => {
    // Option 1: Append new instance to the existing list
    setInstances((prevInstances) => [...prevInstances, newInstance]);

    // Option 2: Refetch the instances to ensure the list is up to date
    fetchInstances(); // Uncomment this if you want to refetch instead of manually updating the state
  };
